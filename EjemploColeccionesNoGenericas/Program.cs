...
// Remover y mostrar elemento
Console.WriteLine($"Elemento removido: {miQ.Dequeue()}");
ImprimirValores(miQ);

// Mostrar el siguiente elemento en la cola sin removelo
...
// Mostrar el siguiente elemento en la pila sin removelo
...
// La propiedad Item predeterminada se puede usar
// para cambiar el valor asociado a una clave
abrirCon["rtf"] = "winword.exe";
Console.WriteLine("Para la clave = \"rtf\", el valor es {0}.", abrirCon["rtf"]);

// Si una clave no existe, al establecer la propiedad Item 
// predeterminada para esa clave, se agrega un nuevo par clave/valor
...
if(!abrirCon.ContainsKey("ht"))
{
    ...
    Console.WriteLine("Valor agregado para la clave = \"ht\": " +
        "{0}", abrirCon["ht"]);
}
...
// Los elementos de la colección ValueCollection están fuertemente
// tipados con el tipo especificado para los valores de la Hashtable
Console.WriteLine();
...
// Los elementos de la colección KeyCollection están fuertemente
// tipados con el tipo especificado para las claves de la Hashtable
Console.WriteLine();
